...
public class DemoSharedEditorTest extends TestCase {
  ...
  // Verify that the 3 folders and 7 files exists under demo/sharedEditor folder (irving release)
  //Verify that the 3 folders and 5 files exists under demo/sharedEditor folder (judah release) //.classpath and .project files does not exist
  ...
  //Verify that the forms_rt.jar 1 file exists under demo/sharedEditor/lib
  ...
  //Verify that the 2 folders exists under /src  
  ...
  //Verify that the 3 folders and 1 file exists under /src/demo/sharedEditor
  ...
  //Verify that the 1 file exists under demo/sharedEditor/src/demo/sharedEditor/beans folder
 ...
 //Verify that the 1 file exists under demo/sharedEditor/src/demo/sharedEditor/ui folder
