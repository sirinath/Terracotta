...
public class DemoConsoleChatPackTest extends TestCase {
 ...
 //	Verify that the 2 folders and 4 files exists under demo/ConsoleChat folder
 ...
 //Verify that the Chatter.java 1 file exists under demo/ConsoleChat/src/demo/consolechat folder
