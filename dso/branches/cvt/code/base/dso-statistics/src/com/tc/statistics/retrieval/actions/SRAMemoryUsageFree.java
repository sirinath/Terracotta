...
public class SRAMemoryUsageFree implements StatisticRetrievalAction {
  private JVMMemoryManager manager;
  
  public SRAMemoryUsageFree() {
  ...
  public StatisticData retrieveStatisticData() {
    return StatisticData.buildInstanceForClassAtLocalhost(getClass(), new Date(), new Long(manager.getMemoryUsage().getFreeMemory()));
  }
}