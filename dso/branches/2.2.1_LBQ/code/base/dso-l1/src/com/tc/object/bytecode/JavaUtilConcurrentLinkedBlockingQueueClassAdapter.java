...
public class JavaUtilConcurrentLinkedBlockingQueueClassAdapter extends ClassAdapter implements Opcodes {
  ...
  private void addTCExtractMethod() {
    ...
    mv.visitVarInsn(ALOAD, 0);
    mv.visitVarInsn(ALOAD, 1);
    mv.visitFieldInsn(PUTFIELD, "java/util/concurrent/LinkedBlockingQueue", "head",
                      "Ljava/util/concurrent/LinkedBlockingQueue$Node;");
    Label l2 = new Label();
    mv.visitLabel(l2);
    ...
    mv.visitLocalVariable("this", "Ljava/util/concurrent/LinkedBlockingQueue;",
                          "Ljava/util/concurrent/LinkedBlockingQueue<TE;>;", l0, l5, 0);
    mv.visitLocalVariable("first", "Ljava/util/concurrent/LinkedBlockingQueue$Node;",
                          "Ljava/util/concurrent/LinkedBlockingQueue$Node<TE;>;", l1, l5, 1);
