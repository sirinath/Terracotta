...
public class LockIdSerializerTest extends TestCase {
  ...
  public void literalLockTest(Object literal) {
    DsoLiteralLockID lock = new DsoLiteralLockID(new DumbClassProvider(), literal);
    Assert.assertEquals(lock, passThrough(lock));
  }

  public void unclusteredLockTest(Object literal) {
    try {
      new DsoLiteralLockID(new DumbClassProvider(), literal);
  ...
  static class DumbClassProvider implements ClassProvider {
