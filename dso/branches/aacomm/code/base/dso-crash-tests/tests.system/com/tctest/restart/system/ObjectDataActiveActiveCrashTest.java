...
public class ObjectDataActiveActiveCrashTest extends ActiveActiveTransparentTestBase implements TestConfigurator {

  private int       clientCount  = 1;
  private final int electionTime = 5;
  
  public ObjectDataActiveActiveCrashTest() {
