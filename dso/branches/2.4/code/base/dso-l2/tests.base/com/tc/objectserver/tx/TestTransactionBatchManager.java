...
public final class TestTransactionBatchManager implements TransactionBatchManager {
  ...
  public void defineBatch(ChannelID channelID, int count) {
    Object[] args = new Object[] { channelID, new Integer(count) };
    try {
  ...
  public boolean batchComponentComplete(ChannelID channelID, TransactionID txnID) {
    batchComponentCompleteCalls.put(new Object[] {channelID, txnID });
