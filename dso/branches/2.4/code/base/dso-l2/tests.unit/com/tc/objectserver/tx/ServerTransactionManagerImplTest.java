...
public class ServerTransactionManagerImplTest extends TestCase {
   ...
   * disconnects.
   * 
   * This test was written to illustrate a scenario where when multiple clients were disconnecting, were acks are being waited for,
   * a concurrent modification exception was thrown.
   */
  public void test2ClientsDisconnectAtTheSameTime() throws Exception {
    ...
    ChannelID cid4 = new ChannelID(4);
    ChannelID cid5 = new ChannelID(5);
    ...
    transactionManager.incomingTransactions(cid2, txnIDs, txns, false, Collections.EMPTY_LIST);
    ...
    transactionManager.incomingTransactions(cid3, txnIDs, txns, false, Collections.EMPTY_LIST);
    ...
    transactionManager.shutdownClient(cid2);
