...
public class TestTVSConfigurationSetupManagerFactoryTest extends TCTestCase {
  ...
  private com.terracottatech.configV3.LockLevel.Enum level(LockLevel in) {
    if (in.equals(LockLevel.CONCURRENT)) return com.terracottatech.configV3.LockLevel.CONCURRENT;
    if (in.equals(LockLevel.READ)) return com.terracottatech.configV3.LockLevel.READ;
    if (in.equals(LockLevel.WRITE)) return com.terracottatech.configV3.LockLevel.WRITE;
