...
public class EhcacheMemoryStoreAdapter extends ClassAdapter implements
	...
	private static class MemoryStoreCreateMethodAdapter extends
		...
		public void visitCode() {
			...
			mv.visitMethodInsn(INVOKEINTERFACE, "net/sf/ehcache/Ehcache", "getMemoryStoreEvictionPolicy", "()Lnet/sf/ehcache/store/MemoryStoreEvictionPolicy;");
			mv.visitFieldInsn(GETSTATIC, "net/sf/ehcache/store/MemoryStoreEvictionPolicy", "DSO", "Lnet/sf/ehcache/store/MemoryStoreEvictionPolicy;");
