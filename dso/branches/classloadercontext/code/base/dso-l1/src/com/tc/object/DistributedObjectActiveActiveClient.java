...
public class DistributedObjectActiveActiveClient extends DistributedObjectClient {
  ...
  public DistributedObjectActiveActiveClient(DSOClientConfigHelper config, TCThreadGroup threadGroup, ClassLoaderRegistry registry,
                                 PreparedComponentsFromL2Connection connectionComponents, Manager manager,
                                 Cluster cluster) {
    super(config, threadGroup, registry, connectionComponents, manager, cluster);
