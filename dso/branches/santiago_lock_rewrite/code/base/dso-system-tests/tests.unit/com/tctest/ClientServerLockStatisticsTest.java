...
//import com.tc.object.locks.ClientServerLockStatManagerGlue;
...
//    clientLockManager = new ClientLockManagerImpl(new NullTCLogger(), sessionManager, clientServerGlue, threadManager, new MockTransactionManager());
//
