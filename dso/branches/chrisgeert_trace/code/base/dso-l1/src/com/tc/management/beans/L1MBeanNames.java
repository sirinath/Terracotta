...
public class L1MBeanNames {
  ...
  public static final ObjectName TRACING_MANAGER_PUBLIC;
  ...
  static {
    try {
      ...
      RUNTIME_OUTPUT_OPTIONS_PUBLIC = TerracottaManagement.createObjectName(Type.DsoClient, Subsystem.Logging, null,
                                                                            ...
                                                                            TerracottaManagement.MBeanDomain.PUBLIC);
      TRACING_MANAGER_PUBLIC = TerracottaManagement.createObjectName(Type.DsoClient, Subsystem.Statistics, null,
                                                                     "Terracotta Method Tracing Manager Bean",
                                                                     TerracottaManagement.MBeanDomain.PUBLIC);
