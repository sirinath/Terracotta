...
public class DSOClientMBeanTestApp extends AbstractTransparentApp {
  ...
  public DSOClientMBeanTestApp(String appId, ApplicationConfig cfg, ListenerProvider listenerProvider) {
    super(appId, cfg, listenerProvider);
    appConfig = cfg;
  }

  public static void visitL1DSOConfig(ConfigVisitor visitor, DSOClientConfigHelper config) {
    String testClass = DSOClientMBeanTestApp.class.getName();
