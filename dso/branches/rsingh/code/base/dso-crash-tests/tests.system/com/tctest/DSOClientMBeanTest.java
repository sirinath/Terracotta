...
public class DSOClientMBeanTest extends TransparentTestBase {
  ...
  public void doSetUp(TransparentTestIface t) throws Exception {
    ...
    cfg.setAttribute(DSOClientMBeanTestApp.CONFIG_FILE, configFile.getAbsolutePath());
    cfg.setAttribute(DSOClientMBeanTestApp.PORT_NUMBER, String.valueOf(port));
    cfg.setAttribute(DSOClientMBeanTestApp.HOST_NAME, "localhost");
    cfg.setAttribute(DSOClientMBeanTestApp.JMX_PORT, String.valueOf(adminPort));
  }

  protected Class getApplicationClass() {
    return DSOClientMBeanTestApp.class;
  }
  ...
  public static TerracottaConfigBuilder createConfig(int port, int adminPort) {
    ...
    String testClassName = DSOClientMBeanTest.class.getName();
    String testClassAppName = DSOClientMBeanTestApp.class.getName();
