...
public class SpringAspectModule implements AspectModule {
  ...
  private void buildDefinitionForScopeProtocol(AspectModuleDeployer deployer) {
    if (hasClass("org.springframework.beans.factory.config.Scope", deployer)) {
      ...
      builder.addAdvice("around",
                        "(execution(* org.springframework.beans.factory.support.AbstractBeanFactory.getBean(String, ..)) || " + //Spring 2.0.x
                        " execution(* org.springframework.beans.factory.support.AbstractBeanFactory.doGetBean(String, ..))) "   //Spring 2.5.x
  ...
  private void buildDefinitionForApplicationContextEventProtocol(final AspectModuleDeployer deployer) {
    ...
    builder.addAdvice(
                   "before",
                   "(execution(* org.springframework.context.support.AbstractApplicationContext+.refresh()) ||" +
                   " execution(* org.springframework.context.support.AbstractApplicationContext+.finishRefresh()) ) "
