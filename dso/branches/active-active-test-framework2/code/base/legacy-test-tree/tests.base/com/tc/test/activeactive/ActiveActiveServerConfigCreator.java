...
public class ActiveActiveServerConfigCreator {
  ...
  private static TCLogger                               logger    = TCLogging
                                                                      .getTestingLogger(ActiveActiveServerConfigCreator.class);
  ...
  private final ActiveActiveTestSetupManager            setupManager;
  private final List[]                                  groups;

  public ActiveActiveServerConfigCreator(ActiveActiveTestSetupManager setupManager, int[] dsoPorts, int[] jmxPorts,
