Terracotta 3.5.3-SNAPSHOT - Simple Scale for Enterprise Java
===================================================
...
http://www.terracotta.org/kit/reflector?kitID=3.5.3&pageID=ReleaseNotes

Help and additional information is available on the web at the following URLs:

 - Product Documentation: 
    http://www.terracotta.org/kit/reflector?kitID=3.5.3&pageID=ProductDocumentation 
