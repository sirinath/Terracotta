Terracotta 3.5.2-SNAPSHOT - Simple Scale for Enterprise Java
===================================================
...
http://www.terracotta.org/kit/reflector?kitID=3.5.1&pageID=ReleaseNotes

Help and additional information is available on the web at the following URLs:

 - Product Documentation: 
    http://www.terracotta.org/kit/reflector?kitID=3.5.1&pageID=ProductDocumentation 
