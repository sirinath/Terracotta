...
public class ApplyTransactionChangeHandler extends AbstractEventHandler {
  ...
  public void handleEvent(final EventContext context) {
    ...
    if (atc.needsApply()) {
      ...
      transactionManager.commit(applyInfo.getObjectsToRelease(), txn.getNewRoots(), Collections.singleton(txn.getServerTransactionID()), applyInfo.getObjectIDsToDelete(), txn.isEviction());
    } else {
      ...
      transactionManager.commit(applyInfo.getObjectsToRelease(), Collections.<String, ObjectID>emptyMap(),
          Collections.<ServerTransactionID>emptySet(), TCCollections.EMPTY_OBJECT_ID_SET, txn.isEviction());
