...
public class EclipsePackTest extends TestCase {
 ...
 //	Verify that the 1 folder and 1 file under tc2.0.0/eclipse folder
  ...
  //Verify that the 4 folders and 2 files exists under /com/html folder
  ...
  //Verify that the 1 folder and 8 files exists under /com/html/ref folder (modified on 7/18/2006
  //modified on 6/30/06
  //Verify that the 1 folder and 9 files exists under /com/html/ref folder // Overview.html file is added(for judah release version 2.0.3 build 3607)
