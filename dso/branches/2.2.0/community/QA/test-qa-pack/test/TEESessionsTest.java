...
public class TEESessionsTest extends TestCase {

  protected void setUp() {
  }

  public static Test suite() {
    return new TestSuite(TEESessionsTest.class);
  }
  ...
  //Verify that the 7 files exists in the terracotta-2.1.0\sessions\bin  
