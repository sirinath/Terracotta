...
public class EhcacheGlobalEviction124TestApp extends ServerCrashingAppBase {
  ...
  public static void visitL1DSOConfig(ConfigVisitor visitor, DSOClientConfigHelper config) {
    ...
    String testClass = EhcacheGlobalEviction124TestApp.class.getName();
  ...
  public static class L1Client {
    ...
    public static void main(String args[]) throws Exception {
      ...
      System.err.println("*************L1.main");
      int index = Integer.parseInt(args[0]);
      System.err.println("*************L1.main: " +index);
