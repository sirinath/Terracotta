...
public class GuiceModule implements Module {
  ...
  public void configure(Binder binder) {
    ...
    // Inject the includeSnapshots anywhere the @TerracottaVersion annotation is used
    binder.bindConstant().annotatedWith(IncludeSnapshots.class).to(config.getIncludeSnapshots());
