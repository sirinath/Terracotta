...
public class RecalledLockNeverRecalledTest extends ServerCrashingTestBase {
  ...
  public void setUp() throws Exception {
    ...
    TCPropertiesImpl.setProperty(TCPropertiesConsts.L1_LOCK_MANAGER_TIMEOUT_INTERVAL, "5000");
  }
  ...
  public static class RecalledLockNeverRecalledTestApp extends ServerCrashingAppBase {
    ...
    long gcTime = TCPropertiesImpl.getProperties().getLong(TCPropertiesConsts.L1_LOCK_MANAGER_TIMEOUT_INTERVAL);
    assert gcTime == 5000;
