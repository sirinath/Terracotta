  ...
  public synchronized void start() {
    ...
    while (maxConnectRetries <= 0 || i < maxConnectRetries) {
      try {
        ...
        CONSOLE_LOGGER.warn("Timeout connecting to server: " + serverHost + ":" + serverPort + ". " + tcte.getMessage());
        ThreadUtil.reallySleep(5000);
      } catch (ConnectException e) {
        CONSOLE_LOGGER.warn("Connection refused from server: " + serverHost + ":" + serverPort);
        ThreadUtil.reallySleep(5000);
      } catch (MaxConnectionsExceededException e) {
        CONSOLE_LOGGER.warn("Connection refused MAXIMUM CONNECTIONS TO SERVER EXCEEDED: " + serverHost + ":"
                           + serverPort);
        ThreadUtil.reallySleep(5000);
