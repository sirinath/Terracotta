...
public class DSOMBeanRegTest {
  ...
  public void setUp() throws Exception {
    ...
    when(channel.getChannelID()).thenAnswer(new Answer<ChannelID>() {
    ...
    SampledCumulativeCounter smcMock = mock(SampledCumulativeCounter.class);
    when(stats.getCounter(Matchers.same(channel), Matchers.startsWith("serverMap"))).thenReturn(smcMock);
