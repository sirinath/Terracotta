...
public class ClassAdapterTest extends ClassAdapterTestBase {
  ...
  static class CustomClassAdapter1 extends ClassVisitor {
    public static final ClassAdapterFactory FACTORY = new ClassAdapterFactory() {
      @Override
      public ClassVisitor create(ClassVisitor classvisitor, ClassLoader classloader) {
  ...
  static class CustomClassAdapter2 extends ClassVisitor {
    public static final ClassAdapterFactory FACTORY = new ClassAdapterFactory() {
      @Override
      public ClassVisitor create(ClassVisitor classvisitor, ClassLoader classloader) {
  ...
  static class CustomClassAdapter3 extends ClassVisitor {
    public static final ClassAdapterFactory FACTORY = new ClassAdapterFactory() {
      @Override
