...
public class BasicPackTest extends TestCase {
  ...
  //Verify that the 8 folders and 4 files exists in the root folder tc2.0.x
 ...
 //Verify the bin folder exists under root folder tc2.0.x
  ...
  //Verify that the 6 files exists in the bin folder (which-boot.jar is removed for judah release build 1.3652)
