...
public class TEEDSOTest extends TestCase {

  protected void setUp() {
  }

  public static Test suite() {
    return new TestSuite(TEEDSOTest.class);
  }
  ...
  //2. Verify that the 7 files exists in the terracotta-2.1.0/dso/bin folder (which-boot.jar is removed for judah release build 1.3652)
  ...
  //6. Verify that the 1 folders and 7 files exists under terracotta-2.1.0\dso\Uninstall_Terracotta for DSO folder
