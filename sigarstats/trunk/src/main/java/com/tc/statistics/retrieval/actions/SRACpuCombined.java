...
public class SRACpuCombined implements StatisticRetrievalAction {
  ...
  public StatisticData[] retrieveStatisticData() {
    ...
    try {
      ...
      for (int i = 0; i < cpuPercList.length; i++) {
        ...
        data[i] = new StatisticData(ACTION_NAME, moment, element, Double.isNaN(combined) || Double.isInfinite(combined) ? null : new BigDecimal(format.format(combined)));
      }
      return data;
