...
public class JBoss51xStandaloneLocalConfiguration extends JBossStandaloneLocalConfiguration
{
        ...
        throws MalformedURLException
    {
        ...
        // Terracotta
        String ajpPort = getPropertyValue(JBossPropertySet.JBOSS51X_AJP_CONNECTOR_PORT);
        if (ajpPort == null) ajpPort = "8009";
        String httpPort = getPropertyValue(JBossPropertySet.JBOSS51X_HTTP_CONNECTOR_PORT);
        if (httpPort == null) httpPort = "8443";
        
        getAntUtils().addTokenToFilterChain(filterChain, JBossPropertySet.JBOSS51X_AJP_CONNECTOR_PORT,
        		ajpPort);
        
        getAntUtils().addTokenToFilterChain(filterChain, JBossPropertySet.JBOSS51X_HTTP_CONNECTOR_PORT,
        		httpPort);
        // end
